...
if (!empty($errors)) {
 ...
 ?>
<form accept-charset="utf-8"  method="post" action ="t-edit-query.php?PN=<?php echo($teNo) ?>"  enctype="multipart/form-data" >
    <input type="hidden" name="teNo" value="<?php echo $teNo ;?>" >
...
<div class="d ">
     ...
     <div class="inputs  "> <input  class="Birth"     type="date" name="dob" <?php  echo 'value=" '.$DoB.'"' ?>  >                     </div>
     ...
     <div class="inputs  "> <textarea class="note"  name="notes"  <?php  echo 'value=" '.$notes.'"' ?> ></textarea>             </div>
